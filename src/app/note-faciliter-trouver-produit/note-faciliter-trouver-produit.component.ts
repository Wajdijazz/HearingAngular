...
TotalReponse=result.length
 ...
 this.lineChart1("Evolution Facilité à trouver les produits Enseigne", this.nom_Societe,this.NoteFaciliteTrouverProduitEnseigne,"chartupperleft")
...
this.lineChart("En relatif vs la concurrence",this.concurrent1,this.concurrent2,this.concurrent3,this.concurrent4, this.chartdata,"chartupperright")
 ...
 this.lineChart1("Evolution Facilité à trouver les produitsMagasin","",this.Month,"chartbottomleft");
