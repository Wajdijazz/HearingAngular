...
TotalReponse=result.length
 ...
 this.lineChart1(this.nom_Societe,this.NoteRapportQualitePrixEnseigne,"chartupperleft")
...
this.lineChart1("",this.Month1,"chartbottomright");
  ...
  onSelected(pointevente): void{
   ...
   this.lineChart1(pointevente,this.NoteRapportQualitePrixMagasin,"chartbottomleft");
  ...
  this.lineChart1(concuurent,this.NoteRapportQualitePrixMagasinConcurrent,"chartbottomright");  
